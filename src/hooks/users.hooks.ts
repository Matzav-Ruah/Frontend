...
export const useLogin = (
    options?: Omit<
        UseMutationOptions<ApiResponse<UserSchema>, ApiError, LoginCredentials>,
        "mutationFn"
    >,
) => {
...
export const useLogout = (
    options?: Omit<
        UseMutationOptions<ApiResponse<void>, ApiError, void>,
        "mutationFn"
    >,
) => {
...
export const useUpdateName = (
    options?: Omit<
        UseMutationOptions<UserSchema, ApiError, UpdateNameSchema>,
        "mutationFn"
    >,
) => {
