...
} from "@/src/mutations/events.mutations";
...
export default function EmotionalWidget({
    ...
    useEffect(() => {
        ...
        if (debouncedState && !selectedState) {
            createEvent({
                emotional_state: debouncedState,
                event_data: {},
                date: widgetDate,
            });
    ...
    return (
        <View className="flex items-center w-full mb-3">
            ...
            <Skeleton show={isLoading} radius={32} height={60} width="100%">
                <View
